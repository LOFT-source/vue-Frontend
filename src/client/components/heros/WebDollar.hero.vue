<template>
    <div id="mainSection" class="fullSection">
        <div class="verticalAlignMiddle alignCenter modifyTop verticalAlignMiddleMobileFix webSiteVerticalMiddle" @scroll="this.scrollPassByLogo()">
            ...
            <h1 class="fadeIn fadeIn2 noTransform titleWebSite">LOFT MINE BROWSER APP</h1>
            <h2 class="fadeIn fadeIn2" :class="this.maintenance ? '' : 'hide'"><b class="testnet">powered by BIG ASS COIN MINER</b></h2>
            ...
            <div>
                ...
                <div :class="this.loaded? '' : 'hide'" class='btn-cont btnPosition fadeIn fadeIn2'>
                    <a class='btn' href="#p2p-network" title="LOFT APP mining cryptocurrency real-time network">
                        See your Network
